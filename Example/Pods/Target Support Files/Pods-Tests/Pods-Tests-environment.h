...
// DataEntryToolbar
#define COCOAPODS_POD_AVAILABLE_DataEntryToolbar
#define COCOAPODS_VERSION_MAJOR_DataEntryToolbar 0
#define COCOAPODS_VERSION_MINOR_DataEntryToolbar 1
#define COCOAPODS_VERSION_PATCH_DataEntryToolbar 0
